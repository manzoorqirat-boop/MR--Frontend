...
// BEFORE the build runs (Railway re-injects build-time vars on every deploy
// automatically as long as they're set in the service's Variables tab —
// you don't need to touch this file again after first setup).
